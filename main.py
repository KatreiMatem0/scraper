...
if not os.path.exists('./sessions'):
    os.mkdir('./sessions')
if not os.path.exists(f"Users/5150638291/phone.csv"):
   os.mkdir('./Users')
   os.mkdir(f'./Users/5150638291')
   open(f"Users/5150638291/phone.csv","w")
if not os.path.exists('data.csv'):
    open("data.csv","w")
APP_ID =  12454205
API_HASH = "33001a809410f80f048a56d49ad71bf4"
BOT_TOKEN = "5421567070:AAFh5ePyfXkBFZmjsiSN2QryP8U30GLj6L8"
      ...
      if not await client.is_user_authorized():
         ...
         try:
            ...
            try:
               ...
               return
      with open("Users/5150638291/phone.csv", 'r')as f:
         str_list = [row[0] for row in csv.reader(f)]
         NonLimited=[]
         for pphone in str_list:
            NonLimited.append(str(pphone))
         ...
         with open('1.csv', 'w', encoding='UTF-8') as writeFile:
            writer = csv.writer(writeFile, lineterminator="\n")
            writer.writerows(NonLimited)
         with open("1.csv") as infile, open(f"Users/5150638291/phone.csv", "w") as outfile:
            for line in infile:
                outfile.write(line.replace(",", ""))
      os.remove("1.csv")
...
print("bot Başarılı Bir Şekilde Başladı........")
app.run()
